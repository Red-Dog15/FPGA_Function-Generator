 ...
 **Button Incrementer:**:<br />
  ...
  * Starting Period of the System (approximately 2,586,939 ps):<br />
  ...
  * These screenshots are taken from modelsim and were taken at the same scale
...
**Switch-Controlled switch multiplexer:**<br />

* A multiplexer controlled whether the PWM square or sine wave is being used.
* Switch incrementer in testbench:
&nbsp; &nbsp; &nbsp; &nbsp; <img width="523" height="128" alt="image" src="https://github.com/user-attachments/assets/a3a661e0-0744-4a35-9259-07c9b56d0bde" />

* as shown in the image, when the switch is logic low, the state changes, and the resulting output waveform also changes.
